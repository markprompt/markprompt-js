...
export function ConversationSelect(): JSX.Element {
  ...
  const conversations = useChatStore((state) => {
    ...
    const conversations = state.conversationsByProjectKey[projectKey];
    if (!conversations) return [];
    return Object.entries(conversations.messagesByConversationId);
  });
  ...
  return (
    <Select
      ...
      items={[
        ...
        { value: 'new', label: '+ Start new conversation' },
      ]}
