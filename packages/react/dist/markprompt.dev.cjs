...
function toReact(context, node2, index2, parent) {
  ...
  if (node2.properties) {
    for (property in node2.properties) {
      if (own8.call(node2.properties, property)) {
...
var submitPrompt = async function(prompt, projectKey, onAnswerChunk, onReferences, options) {
  ...
  options = Object.fromEntries(
    Object.entries(defaultOptions).map(([key, value]) => {
      ...
      return [
        key,
        (_a = options == null ? void 0 : options[key]) != null ? _a : value
      ];
    })
  );
  try {
...
// src/Markprompt.tsx
var Caret = () => {
  return /* @__PURE__ */ import_react3.default.createElement("span", { className: "caret animate-caret inline-block h-[15px] w-[8px] translate-y-[2px] translate-x-[2px] transform rounded-[1px] bg-fuchsia-500 shadow-[0_0px_3px_0px_rgba(217,70,219,0.9)]" });
};
var WithCaret = ({ Component, children, ...rest }) => {
  ...
  return /* @__PURE__ */ import_react3.default.createElement(Component, { ...rest, className: "markdown-node" }, children, /* @__PURE__ */ import_react3.default.createElement(Caret, null));
};
var Markprompt = ({
  model,
  projectKey,
  ...
  const [prompt, setPrompt] = (0, import_react3.useState)(void 0);
  const [answer, setAnswer] = (0, import_react3.useState)("");
  const [references, setReferences] = (0, import_react3.useState)([]);
  const [loading, setLoading] = (0, import_react3.useState)(false);
  const containerRef = (0, import_react3.useRef)(null);
  const answerContainerRef = (0, import_react3.useRef)(null);
  const _didCompleteFirstQuery = (0, import_react3.useRef)(false);
  ...
  (0, import_react3.useEffect)(() => {
    if (autoScrollDisabled || !containerRef.current || !answerContainerRef.current) {
      return;
    }
  ...
  (0, import_react3.useEffect)(() => {
    if (!loading && answer.length > 0) {
      if (!_didCompleteFirstQuery.current) {
        ...
        didCompleteFirstQuery == null ? void 0 : didCompleteFirstQuery();
      }
    }
  }, [loading, answer, didCompleteFirstQuery]);
  return /* @__PURE__ */ import_react3.default.createElement("div", { className: "relative flex h-full flex-col" }, /* @__PURE__ */ import_react3.default.createElement("div", { className: "h-12 border-b border-neutral-900" }, /* @__PURE__ */ import_react3.default.createElement("form", { onSubmit: handleSubmit }, /* @__PURE__ */ import_react3.default.createElement(
    "input",
    {
      value: prompt || "",
      type: "text",
    ...
    loading && !(answer.length > 0) && /* @__PURE__ */ import_react3.default.createElement(Caret, null),
    /* @__PURE__ */ import_react3.default.createElement(
      "div",
      {
        className: (0, import_classnames.default)("prompt-answer", {
      ...
      /* @__PURE__ */ import_react3.default.createElement(
        ...
        {
          components: {
            p: (props) => /* @__PURE__ */ import_react3.default.createElement(WithCaret, { Component: "p", ...props }),
            span: (props) => /* @__PURE__ */ import_react3.default.createElement(WithCaret, { Component: "span", ...props }),
            h1: (props) => /* @__PURE__ */ import_react3.default.createElement(WithCaret, { Component: "h1", ...props }),
            h2: (props) => /* @__PURE__ */ import_react3.default.createElement(WithCaret, { Component: "h2", ...props }),
            h3: (props) => /* @__PURE__ */ import_react3.default.createElement(WithCaret, { Component: "h3", ...props }),
            h4: (props) => /* @__PURE__ */ import_react3.default.createElement(WithCaret, { Component: "h4", ...props }),
            h5: (props) => /* @__PURE__ */ import_react3.default.createElement(WithCaret, { Component: "h5", ...props }),
            h6: (props) => /* @__PURE__ */ import_react3.default.createElement(WithCaret, { Component: "h6", ...props }),
            pre: (props) => /* @__PURE__ */ import_react3.default.createElement(WithCaret, { Component: "pre", ...props }),
            code: (props) => /* @__PURE__ */ import_react3.default.createElement(WithCaret, { Component: "code", ...props }),
            td: (props) => /* @__PURE__ */ import_react3.default.createElement(WithCaret, { Component: "td", ...props })
          },
    ...
    answer.length > 0 && references.length > 0 && /* @__PURE__ */ import_react3.default.createElement("div", { className: "mt-8 border-t border-neutral-900 pt-4 text-sm text-neutral-500" }, /* @__PURE__ */ import_react3.default.createElement("div", { className: "animate-slide-up" }, "Summary generated from the following sources:", /* @__PURE__ */ import_react3.default.createElement("div", { className: "mt-4 flex w-full flex-row flex-wrap items-center gap-2" }, references.map((r) => /* @__PURE__ */ import_react3.default.createElement(
      "div",
      {
        key: `reference-${r}`,
    ...
    /* @__PURE__ */ import_react3.default.createElement("div", { className: "h-8" }),
    /* @__PURE__ */ import_react3.default.createElement("div", { ref: answerContainerRef })
  ));
};
