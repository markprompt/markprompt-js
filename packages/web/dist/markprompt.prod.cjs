...
`}var Np=/\r?\n|\r/g;function Ia(e,t){let n=[],r=0,i=0,o;for(;o=Np.exec(e);)l(e.slice(r,o.index)),n.push(o[0]),r=o.index+o[0].length,i++;return l(e.slice(r)),n.join("");function l(s){n.push(t(s,i,!s))}}function Rn(e){if(!e._compiled){let t=(e.atBreak?"[\\r\\n][\\t ]*":"")+(e.before?"(?:"+e.before+")":"");e._compiled=new RegExp((t?"("+t+")":"")+(/[|\\{}()[\]^$+*?.-]/.test(e.character)?"\\":"")+e.character+(e.after?"(?:"+e.after+")":""),"g")}return e._compiled}function $a(e,t){return za(e,t.inConstruct,!0)&&!za(e,t.notInConstruct,!1)}function za(e,t,n){if(typeof t=="string"&&(t=[t]),!t||t.length===0)return n;let r=-1;for(;++r<t.length;)if(e.includes(t[r]))return!0;return!1}function yi(e,t,n){let r=(n.before||"")+(t||"")+(n.after||""),i=[],o=[],l={},s=-1;for(;++s<e.unsafe.length;){let u=e.unsafe[s];if(!$a(e.stack,u))continue;let p=Rn(u),h;for(;h=p.exec(r);){let f="before"in u||!!u.atBreak,m="after"in u,b=h.index+(f?h[1].length:0);i.includes(b)?(l[b].before&&!f&&(l[b].before=!1),l[b].after&&!m&&(l[b].after=!1)):(i.push(b),l[b]={before:f,after:m})}}i.sort(Rp);let a=n.before?n.before.length:0,c=r.length-(n.after?n.after.length:0);for(s=-1;++s<i.length;){let u=i[s];u<a||u>=c||u+1<c&&i[s+1]===u+1&&l[u].after&&!l[u+1].before&&!l[u+1].after||i[s-1]===u-1&&l[u].before&&!l[u-1].before&&!l[u-1].after||(a!==u&&o.push(Na(r.slice(a,u),"\\")),a=u,/[!-/:-@[-`{-~]/.test(r.charAt(u))&&(!n.encode||!n.encode.includes(r.charAt(u)))?o.push("\\"):(o.push("&#x"+r.charCodeAt(u).toString(16).toUpperCase()+";"),a++))}return o.push(Na(r.slice(a,c),n.after)),o.join("")}function Rp(e,t){return e-t}function Na(e,t){let n=/\\(?=[!-/:-@[-`{-~])/g,r=[],i=[],o=e+t,l=-1,s=0,a;for(;a=n.exec(o);)r.push(a.index);for(;++l<r.length;)s!==r[l]&&i.push(e.slice(s,r[l])),i.push("\\"),s=r[l];return i.push(e.slice(s)),i.join("")}function lt(e){let t=e||{},n=t.now||{},r=t.lineShift||0,i=n.line||1,o=n.column||1;return{move:a,current:l,shift:s};function l(){return{now:{line:i,column:o},lineShift:r}}function s(c){r+=c}function a(c){let u=c||"",p=u.split(/\r?\n|\r/g),h=p[p.length-1];return i+=p.length-1,o=p.length===1?o+h.length:1+h.length+r,u}}Ra.peek=Kp;function bi(){return{enter:{gfmFootnoteDefinition:Mp,gfmFootnoteDefinitionLabelString:Bp,gfmFootnoteCall:jp,gfmFootnoteCallString:qp},exit:{gfmFootnoteDefinition:Up,gfmFootnoteDefinitionLabelString:Hp,gfmFootnoteCall:Wp,gfmFootnoteCallString:Vp}}}function wi(){return{unsafe:[{character:"[",inConstruct:["phrasing","label","reference"]}],handlers:{footnoteDefinition:Qp,footnoteReference:Ra}}}function Mp(e){this.enter({type:"footnoteDefinition",identifier:"",label:"",children:[]},e)}function Bp(){this.buffer()}function Hp(e){let t=this.resume(),n=this.stack[this.stack.length-1];n.label=t,n.identifier=ae(this.sliceSerialize(e)).toLowerCase()}function Up(e){this.exit(e)}function jp(e){this.enter({type:"footnoteReference",identifier:"",label:""},e)}function qp(){this.buffer()}function Vp(e){let t=this.resume(),n=this.stack[this.stack.length-1];n.label=t,n.identifier=ae(this.sliceSerialize(e)).toLowerCase()}function Wp(e){this.exit(e)}function Ra(e,t,n,r){let i=lt(r),o=i.move("[^"),l=n.enter("footnoteReference"),s=n.enter("reference");return o+=i.move(yi(n,xi(e),{...i.current(),before:o,after:"]"})),s(),l(),o+=i.move("]"),o}function Kp(){return"["}function Qp(e,t,n,r){let i=lt(r),o=i.move("[^"),l=n.enter("footnoteDefinition"),s=n.enter("label");return o+=i.move(yi(n,xi(e),{...i.current(),before:o,after:"]"})),s(),o+=i.move("]:"+(e.children&&e.children.length>0?" ":"")),i.shift(4),o+=i.move(Ia(Oa(e,n,i.current()),Yp)),l(),o}function Yp(e,t,n){return t===0?e:(n?"":"    ")+e}function Mn(e,t,n){let r=t.indexStack,i=e.children||[],o=[],l=-1,s=n.before;r.push(-1);let a=t.createTracker(n);for(;++l<i.length;){let c=i[l],u;if(r[r.length-1]=l,l+1<i.length){let p=t.handle.handlers[i[l+1].type];p&&p.peek&&(p=p.peek),u=p?p(i[l+1],e,t,{before:"",after:"",...a.current()}).charAt(0):""}else u=n.after;o.length>0&&(s==="\r"||s===`
`)&&c.type==="html"&&(o[o.length-1]=o[o.length-1].replace(/(\r?\n|\r)$/," "),s=" ",a=t.createTracker(n),a.move(o.join(""))),o.push(a.move(t.handle(c,e,t,{...a.current(),before:s,after:u}))),s=o[o.length-1].slice(-1)}return r.pop(),o.join("")}var Gp=["autolink","destinationLiteral","destinationRaw","reference","titleQuote","titleApostrophe"];Ma.peek=Jp;var ki={canContainEols:["delete"],enter:{strikethrough:Zp},exit:{strikethrough:Xp}},Si={unsafe:[{character:"~",inConstruct:"phrasing",notInConstruct:Gp}],handlers:{delete:Ma}};function Zp(e){this.enter({type:"delete",children:[]},e)}function Xp(e){this.exit(e)}function Ma(e,t,n,r){let i=lt(r),o=n.enter("strikethrough"),l=i.move("~~");return l+=Mn(e,n,{...i.current(),before:l,after:"~"}),l+=i.move("~~"),o(),l}function Jp(){return"~"}Ai.peek=em;function Ai(e,t,n){let r=e.value||"",i="`",o=-1;for(;new RegExp("(^|[^`])"+i+"([^`]|$)").test(r);)i+="`";for(/[^ \r\n]/.test(r)&&(/^[ \r\n]/.test(r)&&/[ \r\n]$/.test(r)||/^`|`$/.test(r))&&(r=" "+r+" ");++o<n.unsafe.length;){let l=n.unsafe[o],s=Rn(l),a;if(l.atBreak)for(;a=s.exec(r);){let c=a.index;r.charCodeAt(c)===10&&r.charCodeAt(c-1)===13&&c--,r=r.slice(0,c)+" "+r.slice(a.index+1)}}return i+r+i}function em(){return"`"}function Ha(e,t={}){let n=(t.align||[]).concat(),r=t.stringLength||nm,i=[],o=[],l=[],s=[],a=0,c=-1;for(;++c<e.length;){let m=[],b=[],S=-1;for(e[c].length>a&&(a=e[c].length);++S<e[c].length;){let x=tm(e[c][S]);if(t.alignDelimiters!==!1){let _=r(x);b[S]=_,(s[S]===void 0||_>s[S])&&(s[S]=_)}m.push(x)}o[c]=m,l[c]=b}let u=-1;if(typeof n=="object"&&"length"in n)for(;++u<a;)i[u]=Ba(n[u]);else{let m=Ba(n);for(;++u<a;)i[u]=m}u=-1;let p=[],h=[];for(;++u<a;){let m=i[u],b="",S="";m===99?(b=":",S=":"):m===108?b=":":m===114&&(S=":");let x=t.alignDelimiters===!1?1:Math.max(1,s[u]-b.length-S.length),_=b+"-".repeat(x)+S;t.alignDelimiters!==!1&&(x=b.length+x+S.length,x>s[u]&&(s[u]=x),h[u]=x),p[u]=_}o.splice(1,0,p),l.splice(1,0,h),c=-1;let f=[];for(;++c<o.length;){let m=o[c],b=l[c];u=-1;let S=[];for(;++u<a;){let x=m[u]||"",_="",C="";if(t.alignDelimiters!==!1){let P=s[u]-(b[u]||0),D=i[u];D===114?_=" ".repeat(P):D===99?P%2?(_=" ".repeat(P/2+.5),C=" ".repeat(P/2-.5)):(_=" ".repeat(P/2),C=_):C=" ".repeat(P)}t.delimiterStart!==!1&&!u&&S.push("|"),t.padding!==!1&&!(t.alignDelimiters===!1&&x==="")&&(t.delimiterStart!==!1||u)&&S.push(" "),t.alignDelimiters!==!1&&S.push(_),S.push(x),t.alignDelimiters!==!1&&S.push(C),t.padding!==!1&&S.push(" "),(t.delimiterEnd!==!1||u!==a-1)&&S.push("|")}f.push(t.delimiterEnd===!1?S.join("").replace(/ +$/,""):S.join(""))}return f.join(`
`)}function tm(e){return e==null?"":String(e)}function nm(e){return e.length}function Ba(e){let t=typeof e=="string"?e.codePointAt(0):0;return t===67||t===99?99:t===76||t===108?108:t===82||t===114?114:0}var vi={enter:{table:rm,tableData:Ua,tableHeader:Ua,tableRow:om},exit:{codeText:lm,table:im,tableData:Ci,tableHeader:Ci,tableRow:Ci}};function rm(e){let t=e._align;this.enter({type:"table",align:t.map(n=>n==="none"?null:n),children:[]},e),this.setData("inTable",!0)}function im(e){this.exit(e),this.setData("inTable")}function om(e){this.enter({type:"tableRow",children:[]},e)}function Ci(e){this.exit(e)}function Ua(e){this.enter({type:"tableCell",children:[]},e)}function lm(e){let t=this.resume();this.getData("inTable")&&(t=t.replace(/\\([\\|])/g,am));let n=this.stack[this.stack.length-1];n.value=t,this.exit(e)}function am(e,t){return t==="|"?t:e}function Ei(e){let t=e||{},n=t.tableCellPadding,r=t.tablePipeAlign,i=t.stringLength,o=n?" ":"|";return{unsafe:[{character:"\r",inConstruct:"tableCell"},{character:`
`,inConstruct:"tableCell"},{atBreak:!0,character:"|",after:"[	 :-]"},{character:"|",inConstruct:"tableCell"},{atBreak:!0,character:":",after:"-"},{atBreak:!0,character:"-",after:"[:|-]"}],handlers:{table:l,tableRow:s,tableCell:a,inlineCode:h}};function l(f,m,b,S){return c(u(f,b,S),f.align)}function s(f,m,b,S){let x=p(f,b,S),_=c([x]);return _.slice(0,_.indexOf(`
`))}function a(f,m,b,S){let x=b.enter("tableCell"),_=b.enter("phrasing"),C=Mn(f,b,{...S,before:o,after:o});return _(),x(),C}function c(f,m){return Ha(f,{align:m,alignDelimiters:r,padding:n,stringLength:i})}function u(f,m,b){let S=f.children,x=-1,_=[],C=m.enter("table");for(;++x<S.length;)_[x]=p(S[x],m,b);return C(),_}function p(f,m,b){let S=f.children,x=-1,_=[],C=m.enter("tableRow");for(;++x<S.length;)_[x]=a(S[x],f,m,b);return C(),_}function h(f,m,b){let S=Ai(f,m,b);return b.stack.includes("tableCell")&&(S=S.replace(/\|/g,"\\$&")),S}}function ja(e){let t=e.options.bullet||"*";if(t!=="*"&&t!=="+"&&t!=="-")throw new Error("Cannot serialize items with `"+t+"` for `options.bullet`, expected `*`, `+`, or `-`");return t}function qa(e){let t=e.options.listItemIndent||"tab";if(t===1||t==="1")return"one";if(t!=="tab"&&t!=="one"&&t!=="mixed")throw new Error("Cannot serialize items with `"+t+"` for `options.listItemIndent`, expected `tab`, `one`, or `mixed`");return t}function Va(e,t,n,r){let i=qa(n),o=n.bulletCurrent||ja(n);t&&t.type==="list"&&t.ordered&&(o=(typeof t.start=="number"&&t.start>-1?t.start:1)+(n.options.incrementListMarker===!1?0:t.children.indexOf(e))+o);let l=o.length+1;(i==="tab"||i==="mixed"&&(t&&t.type==="list"&&t.spread||e.spread))&&(l=Math.ceil(l/4)*4);let s=n.createTracker(r);s.move(o+" ".repeat(l-o.length)),s.shift(l);let a=n.enter("listItem"),c=n.indentLines(n.containerFlow(e,s.current()),u);return a(),c;function u(p,h,f){return h?(f?"":" ".repeat(l))+p:(f?o:o+" ".repeat(l-o.length))+p}}var _i={exit:{taskListCheckValueChecked:Wa,taskListCheckValueUnchecked:Wa,paragraph:sm}},Ti={unsafe:[{atBreak:!0,character:"-",after:"[:|-]"}],handlers:{listItem:um}};function Wa(e){let t=this.stack[this.stack.length-2];t.checked=e.type==="taskListCheckValueChecked"}function sm(e){let t=this.stack[this.stack.length-2];if(t&&t.type==="listItem"&&typeof t.checked=="boolean"){let n=this.stack[this.stack.length-1],r=n.children[0];if(r&&r.type==="text"){let i=t.children,o=-1,l;for(;++o<i.length;){let s=i[o];if(s.type==="paragraph"){l=s;break}}l===n&&(r.value=r.value.slice(1),r.value.length===0?n.children.shift():n.position&&r.position&&typeof r.position.start.offset=="number"&&(r.position.start.column++,r.position.start.offset++,n.position.start=Object.assign({},r.position.start)))}}this.exit(e)}function um(e,t,n,r){let i=e.children[0],o=typeof e.checked=="boolean"&&i&&i.type==="paragraph",l="["+(e.checked?"x":" ")+"] ",s=lt(r);o&&s.move(l);let a=Va(e,t,n,{...r,...s.current()});return o&&(a=a.replace(/^(?:[*+-]|\d+\.)([\r\n]| {1,3})/,c)),a;function c(u){return u+l}}function Li(){return[di,bi(),ki,vi,_i]}function Pi(e){return{extensions:[gi,wi(),Si,Ei(e),Ti]}}function Fi(e={}){let t=this.data();n("micromarkExtensions",La(e)),n("fromMarkdownExtensions",Li()),n("toMarkdownExtensions",Pi(e));function n(r,i){(t[r]?t[r]:t[r]=[]).push(i)}}var{I:g0}=io,Ka=e=>e===null||typeof e!="object"&&typeof e!="function";var Qa=e=>e.strings===void 0;var Vt=(e,t)=>{var n,r;let i=e._$AN;if(i===void 0)return!1;for(let o of i)(r=(n=o)._$AO)===null||r===void 0||r.call(n,t,!1),Vt(o,t);return!0},Bn=e=>{let t,n;do{if((t=e._$AM)===void 0)break;n=t._$AN,n.delete(e),e=t}while((n==null?void 0:n.size)===0)},Ya=e=>{for(let t;t=e._$AM;e=t){let n=t._$AN;if(n===void 0)t._$AN=n=new Set;else if(n.has(e))break;n.add(e),mm(t)}};function cm(e){this._$AN!==void 0?(Bn(this),this._$AM=e,Ya(this)):this._$AM=e}function pm(e,t=!1,n=0){let r=this._$AH,i=this._$AN;if(i!==void 0&&i.size!==0)if(t)if(Array.isArray(r))for(let o=n;o<r.length;o++)Vt(r[o],!1),Bn(r[o]);else r!=null&&(Vt(r,!1),Bn(r));else Vt(this,e)}var mm=e=>{var t,n,r,i;e.type==Ye.CHILD&&((t=(r=e)._$AP)!==null&&t!==void 0||(r._$AP=pm),(n=(i=e)._$AQ)!==null&&n!==void 0||(i._$AQ=cm))},Hn=class extends Fe{constructor(){super(...arguments),this._$AN=void 0}_$AT(t,n,r){super._$AT(t,n,r),Ya(this),this.isConnected=t._$AU}_$AO(t,n=!0){var r,i;t!==this.isConnected&&(this.isConnected=t,t?(r=this.reconnected)===null||r===void 0||r.call(this):(i=this.disconnected)===null||i===void 0||i.call(this)),n&&(Vt(this,t),Bn(this))}setValue(t){if(Qa(this._$Ct))this._$Ct._$AI(t,this);else{let n=[...this._$Ct._$AH];n[this._$Ci]=t,this._$Ct._$AI(n,this,0)}}disconnected(){}reconnected(){}};var Un=class{constructor(t){this.G=t}disconnect(){this.G=void 0}reconnect(t){this.G=t}deref(){return this.G}},jn=class{constructor(){this.Y=void 0,this.Z=void 0}get(){return this.Y}pause(){var t;(t=this.Y)!==null&&t!==void 0||(this.Y=new Promise(n=>this.Z=n))}resume(){var t;(t=this.Z)===null||t===void 0||t.call(this),this.Y=this.Z=void 0}};var Ga=e=>!Ka(e)&&typeof e.then=="function",Za=1073741823,Di=class extends Hn{constructor(){super(...arguments),this._$C_t=Za,this._$Cwt=[],this._$Cq=new Un(this),this._$CK=new jn}render(...t){var n;return(n=t.find(r=>!Ga(r)))!==null&&n!==void 0?n:me}update(t,n){let r=this._$Cwt,i=r.length;this._$Cwt=n;let o=this._$Cq,l=this._$CK;this.isConnected||this.disconnected();for(let s=0;s<n.length&&!(s>this._$C_t);s++){let a=n[s];if(!Ga(a))return this._$C_t=s,a;s<i&&a===r[s]||(this._$C_t=Za,i=0,Promise.resolve(a).then(async c=>{for(;l.get();)await l.get();let u=o.deref();if(u!==void 0){let p=u._$Cwt.indexOf(a);p>-1&&p<u._$C_t&&(u._$C_t=p,u.setValue(c))}}))}return me}disconnected(){this._$Cq.disconnect(),this._$CK.pause()}reconnected(){this._$Cq.reconnect(this),this._$CK.resume()}},Xa=Ge(Di);var Wt=class extends Fe{constructor(t){if(super(t),this.et=W,t.type!==Ye.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===W||t==null)return this.ft=void 0,this.et=t;if(t===me)return t;if(typeof t!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.et)return this.ft;this.et=t;let n=[t];return n.raw=n,this.ft={_$litType$:this.constructor.resultType,strings:n,values:[]}}};Wt.directiveName="unsafeHTML",Wt.resultType=1;var Ja=Ge(Wt);var ce=class extends we{constructor(){super(...arguments);this.model=or;this.iDontKnowMessage=sn;this.completionsUrl=lr;this.projectKey="";this.placeholder="Ask me anything\u2026";this.prompt="";this.idToRefMap={};this.loading=!1;this.answer="";this.references=[]}onInput(n){let r=n.target;this.prompt=r.value}scrollToBottom(){let n=this.renderRoot.querySelector("#result");n.scrollTop=n.scrollHeight}getRefFromId(n){}reset(){let n=this.renderRoot.querySelector("#prompt-input");n.value="",this.answer="",this.references=[],this.loading=!1}focus(){this.renderRoot.querySelector("#prompt-input").focus()}async onSubmit(n){n.preventDefault(),this.prompt!==""&&(this.answer="",this.references=[],this.loading=!0,console.log("this.promptTemplate",this.promptTemplate),await so(this.prompt,this.projectKey,r=>{this.scrollToBottom(),this.answer+=r},r=>{this.scrollToBottom(),this.references=r},{model:this.model,iDontKnowMessage:this.iDontKnowMessage,completionsUrl:this.completionsUrl,...this.promptTemplate?{promptTemplate:this.promptTemplate}:{}}),this.loading=!1)}async renderMarkdown(n){let r=await xr().use(ol).use(Fi).use(Br,{allowDangerousHtml:!0}).use(jr).use(Nn).process(n);return typeof r.value!="string"?"":Ja(r.value)}render(){return Pe`
      <div class="root">
  ...
  `,ie([he({type:String})],ce.prototype,"model",2),ie([he({type:String})],ce.prototype,"promptTemplate",2),ie([he({type:String})],ce.prototype,"iDontKnowMessage",2),ie([he({type:String})],ce.prototype,"completionsUrl",2),ie([he({type:String})],ce.prototype,"projectKey",2),ie([he({type:String})],ce.prototype,"placeholder",2),ie([he({type:String,state:!0})],ce.prototype,"prompt",2),ie([he({type:Object})],ce.prototype,"idToRefMap",2),ie([he({type:Boolean,state:!0})],ce.prototype,"loading",2),ie([he({type:String,state:!0})],ce.prototype,"answer",2),ie([he({type:Array,state:!0})],ce.prototype,"references",2),ce=ie([an("markprompt-content")],ce);var Kt=class extends we{render(){return Pe`<span></span>`}};Kt.styles=_t`
    :host {
  ...
  `,Kt=ie([an("animated-caret")],Kt);var kt=class extends we{constructor(){super(...arguments);this.class=""}render(){return Pe`
      <div
  ...
  `,ie([he({type:String})],kt.prototype,"class",2),kt=ie([an("prose-block")],kt);
